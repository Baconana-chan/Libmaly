...
// Pure utility functions for merging, normalising, and post-processing game
// metadata snapshots.  Platform-agnostic — no Tauri imports.
// Tauri invoke wrappers (invokeMetadataForUrl, invokeMetadataBySource) live in
// src/lib/metadata.ts.
...
// metadataSourceLabel lives in helpers.ts; re-exported here so callers that
// only need metadata utilities do not need a second import.
